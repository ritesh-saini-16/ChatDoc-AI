...
function UploadFromComputer(_a) {
        ...
        var newPromise = new Promise(function (resolve, reject) {
            try {
                edgestore.publicFiles
                    ...
                    var ref = collection(db, "".concat(user.email, "/files/pdf"));
                    addDoc(ref, postData).then(function (res) {
                        router.push("/pdf/".concat(res.id));
                        onClose();
                        resolve(res.id);
                    });
                });
    ...
    return (<div className="">
      <div className="my-4 ">
        ...
        }} className="w-full py-1 px-2 bg-gray-200 shadow-sm border rounded-sm" id="file_input" type="file" accept="application/pdf" data-max-size="1024"/>
